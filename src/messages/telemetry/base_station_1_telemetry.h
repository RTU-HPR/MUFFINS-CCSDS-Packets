...
namespace BaseStation1Telemetry
{
  namespace TelecommandAckowledgement
  {
    ...
    {
      uint16_t apid = BaseStation1APID::TELECOMMAND_ACKNOWLEDGEMENT;
  ...
  namespace SystemStatus
  {
        ...
        const uint8_t &transmitting_allowed)
    {
      ...
      uint16_t apid = BaseStation1APID::SYSTEM_STATUS;
  ...
  namespace Configuration
  {
    ...
    {
      uint16_t apid = BaseStation1APID::CONFIGURATION;
      uint16_t data_values_count = 5;
      Converter data_values[data_values_count] = {
          {.f = lora_frequency},
          {.ui8 = lora_tx_power},
  ...
  namespace Location
  {
    ...
    {
      uint16_t apid = BaseStation1APID::LOCATION;
  ...
  namespace RotatorStatus
  {
    ...
    {
      uint16_t apid = BaseStation1APID::SUBSYSTEM_1_STATUS;
      uint16_t data_values_count = 4;
      Converter data_values[data_values_count] = {
          {.f = target_azimuth},
          {.f = target_elevation},
  ...
  namespace RangingStatus
  {
    ...
    {
      uint16_t apid = BaseStation1APID::SUBSYSTEM_2_STATUS;
      uint16_t data_values_count = 1;
